...
public class strclass {
    ...
    public static class node {
        ...
        public String full_name = "";//  VARCHAR2(500),
        public String short_name = "";     //VARCHAR2(500),
        public int network_id;   // NUMBER(18) default '0' not null,
        int node_id;       //NUMBER(18) default '0' not null,
        public int vendor_type; // NUMBER(18) default '0' not null,
        public int type; // NUMBER(18) default '0' not null,
        public int status;// NUMBER(18) default '0' not null,
        public int admin_status; //NUMBER(18) default '0' not null,
        public String inter_net_addr;//VARCHAR2(600),
        public int no_of_shelves;//NUMBER(18) default '0' not null,
        public String internal_addr; //VARCHAR2(200),
        public int issyncok; // NUMBER(18),
        public String useraccount;   //VARCHAR2(500),
        public String userpassword; // VARCHAR2(500),
        public String nodeversion;   //VARCHAR2(300),
        public int cityid; // NUMBER(18),
        public int areaid; //NUMBER(18),
        public int siteid; // NUMBER(18),
        public long switch_shelves;//INTEGER,
        public int resid; // NUMBER(18),
        public int factory; //NUMBER(18),
        public String syncerrorinfo;  //VARCHAR2(4000),
        public String enablepwd;     //VARCHAR2(200),
        public String snmprpwd;    //VARCHAR2(200),
        public int roomidinnm; // NUMBER(18),
        public int cityidinnm;//NUMBER(18),
        public String address; //VARCHAR2(200),
        public String nameinnm;
        public int nmsync;        // NUMBER(11),
        public String netlayer;// VARCHAR2(200),
        public String vendor; //VARCHAR2(100),
        public String datasource; //VARCHAR2(100),
        public String synlasttime; //VARCHAR2(100),
        public String type_str; //VARCHAR2(255),
        public String remark;//VARCHAR2(255),
        public int gisx; //NUMBER(11) default 0,
        public int gisy; //NUMBER(11) default 0,
        public int eventtypes; //NUMBER(11) default 0,
        public int stationid; //NUMBER(18) default 0,
        public int eventid; //NUMBER(11) default 0,
        public String addtionalinfo; //VARCHAR2(255)
    }

    public static class pathtrace {
        public long network_id;//  NUMBER(18) default '0' not null,
        public long path_id;   // NUMBER(18) default '0' not null,
        public long serial_id; // NUMBER(18) default '0' not null,
        public long anode_id;  // NUMBER(18),
        public long ashelf_id;  // NUMBER(18),
        public long aslot_id;  // NUMBER(18),
        public long aport_id;   // NUMBER(18),
        public long atimeslot_id;// NUMBER(18) default -1,
        public long znode_id;   // NUMBER(18),
        public long zshelf_id;  // NUMBER(18),
        public long zslot_id;   // NUMBER(18),
        public long zport_id;   // NUMBER(18),
        public long ztimeslot_id; //NUMBER(18) default -1,
        public long adlci;       //NUMBER(18) default -1,
        public long avpi;      // NUMBER(18) default -1,
        public long avci;      // NUMBER(18) default -1,
        public long zdlci;      // NUMBER(18) default -1,
        public long zvpi;     // NUMBER(18) default -1,
        public long zvci;     // NUMBER(18) default -1,
        public long loopid;     //INTEGER default -1 not null,
        public long subloopid;   //INTEGER default -1 not null,
        public long actpidnm;   // NUMBER default -1,
        public long zctpidnm;   // NUMBER default -1,
        public long routeseq;   // NUMBER(18) default -1,
        public long channelseq; // NUMBER(18) default -1,
        public long type;    // NUMBER(18) default -1,
        public long channeltype;// NUMBER(18) default -1,
        public long orentation;  //NUMBER(11) default -1,
        public long aneldnm;   // NUMBER(18) default -1,
        public long aportldnm;  // NUMBER(18) default -1,
        public long actpldnm;  // NUMBER(18) default -1,
        public long zneldnm;    // NUMBER(18) default -1,
        public long zportldnm; //  NUMBER(18) default -1,
        public long zctpldnm;  //  NUMBER(18) default -1,
        public String aslot_type; // VARCHAR2(30),
        public String zslot_type; // VARCHAR2(30),
        public String aendddf;   // VARCHAR2(100),
        public String aendoppddf; // VARCHAR2(50),
        public String zendddf;    //VARCHAR2(100),
        public String zendoppddf; // VARCHAR2(50),
        public String channelno;  // VARCHAR2(50),
        public String trip_delay; // VARCHAR2(50),
        public String aatmif;    // VARCHAR2(50),
        public String zatmif;    // VARCHAR2(50),
        public String anode_name; // VARCHAR2(50),
        public String znode_name; // VARCHAR2(50),
        public long aneidnm;  // NUMBER(18),
        public long aportidnm; // NUMBER(18),
        public long zneidnm;  // NUMBER(18),
        public long zportidnm;  // NUMBER(18)
    }
    ...
    public static class mysql_path {
        ...
        public long longdistance;//          INTEGER default 0,
