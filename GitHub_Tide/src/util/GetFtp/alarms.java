...
public class alarms {
    ...
    private static util.socketclient.socketclient scoket1 = new util.socketclient.socketclient();
    ...
    public String return_alarm_path_open(String nodename, String nodeid, String pathid, int _alarmlevel, String _slot, String _port, String _value, String _alm_Con, String _alarm_type, String str_desc) {
    ...
    public String return_alarm_path_clear(String nodename, String nodeid, String pathid, int _alarmlevel, String _slot, String _port, String _value, String _alm_Con, String _alarm_type, String str_desc) {
    ...
    public String return_alarm_device_open(String nodeid, String pathid, int _alarmlevel, String _alm_Con, String _alarm_type, String str_desc, String _slot, String _port) {
    ...
    public String return_alarm_device_clear(String nodeid, String pathid, int _alarmlevel, String _alm_Con, String _alarm_type, String str_desc, String _slot, String _port) {
